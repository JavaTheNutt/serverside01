			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="company_name" id="company_name" class="form-control" required autofocus
						   pattern="[A-Za-z ]{3,}" title="Please enter a valid Company Name" disabled value="<?php echo $companyname?>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="company_city" id="company_city" class="form-control"
						   pattern="[A-Za-z ]{3,}" title="Please enter a valid City Name" disabled value="<?php echo $companycity ?>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="company_rep" id="company_rep" class="form-control" autofocus
						   pattern="[A-Za-z ]{3,}" title="Please enter a valid Company Rep" disabled value="<?php echo $representative?>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="email" name="rep_email" id="rep_email" class="form-control" autofocus
						   ...
						   title="Please enter a valid email address" disabled value="<?php echo $representativeemail ?>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="url" name="company_website" id="company_website" class="form-control" required
						   autofocus pattern="https?://[a-zA-Z]{3}\.[a-zA-Z0-9]{2,}\.[a-zA-Z0-9]{2,}" value="<?php echo $website ?>"
